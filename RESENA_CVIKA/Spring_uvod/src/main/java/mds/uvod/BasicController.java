...
@RequestMapping("basic")   //Nastavení cesty v URL. Všechny metody v této třídě budou v cestě http://localhost:8080/basic/
public class BasicController {
    ...
    public String helloForm() {
        String html =
                "<html>" +
                    "<body>" +
                        "<form method='post' action='hello'>" + //'action' dělá ten redirecting tak, aby to z formuláře šlo na adresu '/hello', která je zpracovávána skrze metodu 'helloTest'.
                            "<input type='text' name='name'/>" + //'name' proto, aby cokoli zadám bylo vloženo do proměnné 'name' metody 'helloTest', která to dále zpracuje a pošle to na adresu '/hello'
